...
typedef struct {
    char placa[10];
    int tempo; // vamos usar para saber se a vaga está ocupada ou não
    int ruaID;
} carros;
...
int main (){
    ...
    int valida; // a2[Para validações em geral]
